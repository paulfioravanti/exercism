...
class LuhnTest(unittest.TestCase):
    ...
    def test_valid_strings_with_a_non_digit_added_at_the_end_become_invalid(self):  # nopep8
    ...
    def test_very_long_input_is_valid(self):
        self.assertIs(Luhn("9999999999 9999999999 9999999999 9999999999").valid(), True)  # nopep8

    def test_valid_luhn_with_an_odd_number_of_digits_and_non_zero_first_digit(self):  # nopep8
    ...
    def test_non_numeric_non_space_char_in_the_middle_with_a_sum_that_s_divisible_by_10_isn_t_allowed(  # nopep8
        self,
    ):
